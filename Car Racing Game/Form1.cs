...
namespace Car_Racing_Game
{
    ...
    { 
        ...
        private void Stop()
        {
            ...
            button1.Enabled = true; // disable the button when game is running

            explosion.Visible = false; // hide the explosion image

            trafficSpeed = 0; // set the traffic back to default

            roadSpeed = 0; // set the road speed back to default
